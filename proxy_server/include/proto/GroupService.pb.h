...
// bool verify = 2;
inline void AddGroupResponse::clear_verify() {
  verify_ = false;
}
inline bool AddGroupResponse::_internal_verify() const {
  return verify_;
}
inline bool AddGroupResponse::verify() const {
  // @@protoc_insertion_point(field_get:rj_GroupService.AddGroupResponse.verify)
  return _internal_verify();
}
inline void AddGroupResponse::_internal_set_verify(bool value) {
  
  verify_ = value;
}
inline void AddGroupResponse::set_verify(bool value) {
  _internal_set_verify(value);
  // @@protoc_insertion_point(field_set:rj_GroupService.AddGroupResponse.verify)
}
