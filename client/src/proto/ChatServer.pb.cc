...
static void InitDefaultsscc_info_GroupRequest_ChatServer_2eproto() {
  ...
  ::rj_ChatServer::GroupRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_MsgRequest_ChatServer_2eproto() {
  ...
  ::rj_ChatServer::MsgRequest::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ChatServer_2eproto = {
  &descriptor_table_ChatServer_2eproto_initialized, descriptor_table_protodef_ChatServer_2eproto, "ChatServer.proto", 164,
...
MsgRequest::MsgRequest()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:rj_ChatServer.MsgRequest)
}
...
GroupRequest::GroupRequest()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:rj_ChatServer.GroupRequest)
}
...
template<> PROTOBUF_NOINLINE ::rj_ChatServer::MsgRequest* Arena::CreateMaybeMessage< ::rj_ChatServer::MsgRequest >(Arena* arena) {
  return Arena::CreateInternal< ::rj_ChatServer::MsgRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::rj_ChatServer::GroupRequest* Arena::CreateMaybeMessage< ::rj_ChatServer::GroupRequest >(Arena* arena) {
  return Arena::CreateInternal< ::rj_ChatServer::GroupRequest >(arena);
}
